package com.example.campingontop.domain.mysql.house.service;

import com.example.campingontop.domain.mysql.house.model.request.GetHouseListPagingByLocReq;
import com.example.campingontop.domain.mysql.house.model.request.PatchUpdateHouseDtoReq;
import com.example.campingontop.domain.mysql.house.model.request.PostCreateHouseDtoReq;
import com.example.campingontop.domain.mysql.house.model.response.GetFindHouseDtoRes;
import com.example.campingontop.domain.mysql.house.model.response.GetHouseLikeDtoRes;
import com.example.campingontop.domain.mysql.house.model.response.PatchUpdateHouseDtoRes;
import com.example.campingontop.domain.mysql.house.model.response.PostCreateHouseDtoRes;
...
import com.example.campingontop.domain.mysql.houseImage.service.HouseImageService;
